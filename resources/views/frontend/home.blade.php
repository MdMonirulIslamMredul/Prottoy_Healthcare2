...
@section('title', 'Home')
@section('meta_description', 'Prottoy Healthcare - Leading healthcare management system in Bangladesh providing
...
@section('content')
    <!-- Hero Carousel Section -->
    <section id="heroCarousel" class="hero-carousel carousel slide carousel-fade" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
                    ...
                    <div class="carousel-content">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h1
                                        class="carousel-title {{ $index == 0 ? 'animate__animated animate__fadeInUp' : '' }}">
                                        {{ $slider->title }}
                                    </h1>
                                    @if ($slider->subtitle)
                                        <p
                                            class="carousel-subtitle {{ $index == 0 ? 'animate__animated animate__fadeInUp animate__delay-1s' : '' }}">
                                            {{ $slider->subtitle }}
                                        </p>
                                    @endif
                                    @if ($slider->button_text && $slider->button_link)
                                        <div
                                            class="hero-buttons {{ $index == 0 ? 'animate__animated animate__fadeInUp animate__delay-2s' : '' }}">
            ...
            @empty
                ...
                <div class="carousel-item active"
                    style="background-image: url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1920');">
                    <div class="carousel-content">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h1 class="carousel-title">Welcome to Prottoy Healthcare</h1>
                                    <p class="carousel-subtitle">Your trusted partner in comprehensive healthcare management
                                        across Bangladesh</p>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-9">
                    @if ($newsEvents->count() > 0)
                        ...
                        <div id="newsEventsCarousel" class="carousel slide mb-4" data-bs-ride="carousel"
                            data-bs-interval="5000">
                            @if ($newsEvents->count() > 1)
                                <div class="carousel-indicators">
                                    @foreach ($newsEvents as $index => $newsEvent)
                                        <button type="button" data-bs-target="#newsEventsCarousel"
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-10">
                                                <div class="card shadow-sm news-card"
                                                    onclick="window.location.href='{{ route('frontend.news-event.show', $newsEvent->id) }}'">
                                                    @if ($newsEvent->image)
                                                        <div class="news-card-image">
                                                            <img src="{{ asset('storage/' . $newsEvent->image) }}"
                                                                alt="{{ $newsEvent->title }}" class="card-img-top"
                            ...
                            @if ($newsEvents->count() > 1)
                                <button class="carousel-control-prev" type="button" data-bs-target="#newsEventsCarousel"
                                    data-bs-slide="prev" style="width: 5%;">
                                    <span class="carousel-control-prev-icon bg-primary rounded-circle p-3"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#newsEventsCarousel"
                            ...
                            @if ($notices->count() > 0)
                                <div class="list-group list-group-flush">
                                    @foreach ($notices->take(4) as $notice)
                                        <div class="list-group-item notice-sidebar-item"
                                            onclick="window.location.href='{{ route('frontend.notice.show', $notice->id) }}'">
                                            <span
                                                class="notice-badge badge mb-2
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Comprehensive healthcare coverage with trusted service providers across the
                            nation.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Experienced healthcare professionals dedicated to providing quality care and
                            support.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Round-the-clock customer service to assist you with all your healthcare
                            needs.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Service network spanning across all divisions and districts of Bangladesh.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Streamlined claim process with fast approval and hassle-free documentation.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="text-muted">Committed to maintaining the highest standards of healthcare service
                            delivery.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                @forelse($services as $service)
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            ...
                            @else
                                <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=500"
                                    alt="{{ $service->title }}">
                            @endif
                ...
                @empty
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <img src="https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=500"
                                        ...
                                        <div class="testimonial-card">
                                            @if ($testimonial->customer_photo)
                                                <img src="{{ asset('storage/' . $testimonial->customer_photo) }}"
                                                    alt="{{ $testimonial->customer_name }}" class="testimonial-photo">
                                            @else
                                                <div class="testimonial-photo d-flex align-items-center justify-content-center"
                                            ...
                                            @if ($testimonial->customer_designation)
                                                <p class="testimonial-designation">
                                                    {{ $testimonial->customer_designation }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <p class="mb-4" style="font-size: 1.2rem;">Join thousands of satisfied customers and experience quality
                healthcare</p>
