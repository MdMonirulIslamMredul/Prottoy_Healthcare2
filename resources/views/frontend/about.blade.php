...
@section('content')
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="fade-in-up"> আমাদের সম্পর্কে </h1>
            <p class="fade-in-up">স্মার্ট হেলথকেয়ার লিমিটেড</p>
        </div>
    </div>
                    ...
                    <div class="mv-card">
                        ...
                        <p class="mv-text">
                            @if ($mission)
                                {{ $mission->content }}
                            @else
                                To provide accessible, affordable, and quality healthcare services to every citizen of
                                Bangladesh.
                                We strive to create a comprehensive healthcare ecosystem that ensures timely medical
                                assistance,
                                seamless claims processing, and continuous support for all our members. Our mission is to
                                bridge
                                the gap between healthcare providers and patients, making quality healthcare a reality for
                                everyone.
                            @endif
                        </p>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="mv-card">
                        @if ($vision && $vision->image)
                            <img src="{{ asset('storage/' . $vision->image) }}" alt="Vision"
                                class="img-fluid rounded mb-3">
                        @endif
                        <div class="mv-icon">
                            <i class="bi bi-eye"></i>
                        ...
                        <p class="mv-text">
                            @if ($vision)
                                {{ $vision->content }}
                            @else
                                To become the most trusted and preferred healthcare management organization in Bangladesh by
                                2030.
                                We envision a future where every individual has access to world-class healthcare services
                                regardless
                                of their location or economic status. Through innovation, technology, and unwavering
                                commitment,
                                we aim to set new standards in healthcare delivery and customer satisfaction across the
                                nation.
                            @endif
                        </p>
                    </div>
                                            ...
                                            @if ($leader->email)
                                                <p class="mb-2">
                                                    ...
                                                    <a href="mailto:{{ $leader->email }}"
                                                        class="text-decoration-none">{{ $leader->email }}</a>
                                                </p>
                                            @endif
                                            @if ($leader->phone)
                                                <p class="mb-2">
                                                    ...
                                                    <a href="tel:{{ $leader->phone }}"
                                                        class="text-decoration-none">{{ $leader->phone }}</a>
                                                </p>
                                            @endif
                                        </div>
                                    @endif
