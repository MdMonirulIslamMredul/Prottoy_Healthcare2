                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted">See the complete organizational structure from your upazila
                                        level</p>
                                </div>
                                <div class="flex-shrink-0">
                                        ...
                                        @foreach ($recentPackagePurchases as $index => $purchase)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <small
                                                        class="text-muted">{{ Str::limit($purchase->package->details, 40) }}</small>
                                                </td>
                                                ...
                                                <td class="text-danger">৳{{ number_format($purchase->due_amount, 2) }}
                                                </td>
                                                <td>
