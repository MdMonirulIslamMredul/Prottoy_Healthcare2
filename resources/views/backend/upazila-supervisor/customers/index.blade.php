...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('upazilasupervisor.customers.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-primary">{{ $customer->pho->name ?? 'N/A' }}</small>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('upazilasupervisor.customers.edit', $customer->id) }}"
                                           class="btn btn-sm btn-warning">
                                            <i class="bi bi-pencil"></i> Edit
                                        </a>
                                        <form action="{{ route('upazilasupervisor.customers.destroy', $customer->id) }}"
                                              method="POST"
                                              class="d-inline"
