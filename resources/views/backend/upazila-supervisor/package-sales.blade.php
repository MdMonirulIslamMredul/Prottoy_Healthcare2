...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">View all package sales by PHOs under your supervision</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('upazilasupervisor.package-sales') }}" class="row g-3">
                <div class="col-md-3">
    ...
    <div class="mt-3">
        <a href="{{ route('upazilasupervisor.dashboard') }}" class="btn btn-secondary">
