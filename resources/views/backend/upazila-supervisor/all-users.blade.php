    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('upazilasupervisor.all-users') }}" id="filterForm">
                        <div class="row g-3">
                            <!-- PHO Filter -->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 d-flex align-items-end">
                                ...
                                <a href="{{ route('upazilasupervisor.all-users') }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if($users->count() > 0)
                            <a href="{{ route('upazilasupervisor.generate-users-report', request()->all()) }}" class="btn btn-danger btn-sm" target="_blank">
