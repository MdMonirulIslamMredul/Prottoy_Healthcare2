...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('districtmanager.customers.index') }}" class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('districtmanager.customers.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('districtmanager.customers.index') }}" class="btn btn-secondary">Cancel</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Client-side phone validation (local-only 01XXXXXXXXX)
