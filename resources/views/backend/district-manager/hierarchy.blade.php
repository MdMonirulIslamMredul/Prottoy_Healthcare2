...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Complete organizational structure for {{ $districtManager->district->name }}</p>
                </div>
                <a href="{{ route('districtmanager.dashboard') }}" class="btn btn-outline-secondary">
            ...
            <div class="card border-success shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">{{ $districtManager->name }}</h5>
                            <p class="mb-0 text-muted">District Manager - {{ $districtManager->district->name }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if($upzilas->isEmpty())
        <div class="alert alert-info">
            <i class="bi bi-info-circle me-2"></i>No upazilas found in this district.
        </div>
    @else
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="mb-0">{{ $upzila->name }}</h5>
                                        <p class="mb-0 text-muted">Upazila</p>
                                    </div>
                                    ...
                                    @else
                                        <div class="text-warning">
                                            <i class="bi bi-exclamation-triangle me-1"></i>No Supervisor Assigned
                                        </div>
                                    @endif
                                </div>
