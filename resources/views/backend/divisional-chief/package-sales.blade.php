...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">View all package sales by PHOs in your division</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('divisionalchief.package-sales') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    ...
                    <a href="{{ route('divisionalchief.package-sales') }}" class="btn btn-secondary me-2">
                        <i class="bi bi-x-circle"></i> Clear
                    </a>
                    <a href="{{ route('divisionalchief.generate-package-sales-report', request()->all()) }}" class="btn btn-success" target="_blank">
    ...
    <div class="mt-3">
        <a href="{{ route('divisionalchief.dashboard') }}" class="btn btn-secondary">
