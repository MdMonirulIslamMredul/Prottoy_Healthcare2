    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('divisionalchief.all-users') }}" id="filterForm">
                        <div class="row g-3">
                            <!-- District Filter -->
                            <div class="col-md-3">
                            ...
                            <div class="col-md-12 d-flex align-items-end">
                                ...
                                <a href="{{ route('divisionalchief.all-users') }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if($users->count() > 0)
                            <a href="{{ route('divisionalchief.generate-users-report', request()->all()) }}" class="btn btn-danger btn-sm" target="_blank">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    districtSelect.addEventListener('change', function() {
        ...
        if (districtId) {
            fetch(`/divisionalchief/filter-upzilas-ajax/${districtId}`)
    ...
    upzilaSelect.addEventListener('change', function() {
        ...
        if (upzilaId) {
            fetch(`/divisionalchief/filter-phos/${upzilaId}`)
                .then(response => response.json())
                .then(data => {
                    data.forEach(pho => {
                        const option = document.createElement('option');
