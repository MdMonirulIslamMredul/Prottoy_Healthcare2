...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('divisionalchief.phos.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach($phos as $pho)
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted">{{ $pho->district->name ?? 'N/A' }}</small>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('divisionalchief.phos.edit', $pho->id) }}"
                                           class="btn btn-sm btn-warning">
                                            <i class="bi bi-pencil"></i> Edit
                                        </a>
                                        <form action="{{ route('divisionalchief.phos.destroy', $pho->id) }}"
                                              method="POST"
                                              class="d-inline"
