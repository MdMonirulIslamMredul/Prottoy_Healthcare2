...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('divisionalchief.upazila-supervisors.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach($upazilaSupervisors as $supervisor)
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted">{{ $supervisor->district->name ?? 'N/A' }}</small>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('divisionalchief.upazila-supervisors.edit', $supervisor->id) }}"
                                           class="btn btn-sm btn-warning">
                                            <i class="bi bi-pencil"></i> Edit
                                        </a>
                                        <form action="{{ route('divisionalchief.upazila-supervisors.destroy', $supervisor->id) }}"
                                              method="POST"
                                              class="d-inline"
