                            ...
                            @forelse($phos as $index => $pho)
                                <tr>
                                    ...
                                    <td class="text-success">
                                        ৳{{ number_format($pho->package_sales_sum_paid_amount ?? 0, 0) }}</td>
                                    <td class="text-danger">
                                        ৳{{ number_format($pho->package_sales_sum_due_amount ?? 0, 0) }}</td>
                                    <td>
                                        <a href="{{ route('superadmin.phos.show', $pho->id) }}"
                                        ...
                                        <form action="{{ route('superadmin.phos.destroy', $pho->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
