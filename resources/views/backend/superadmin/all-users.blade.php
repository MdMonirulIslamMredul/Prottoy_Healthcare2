    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('superadmin.all-users') }}" id="filterForm">
                        <div class="row g-3">
                            <!-- Division Filter -->
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 d-flex align-items-end">
                                ...
                                <a href="{{ route('superadmin.all-users') }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if($users->count() > 0)
                            <a href="{{ route('superadmin.generate-users-report', request()->all()) }}" class="btn btn-danger btn-sm" target="_blank">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    divisionSelect.addEventListener('change', function() {
        ...
        upzilaSelect.innerHTML = '<option value="">All Upazilas</option>';
        phoSelect.innerHTML = '<option value="">All PHOs</option>';

        if (divisionId) {
            fetch(`/superadmin/filter-districts/${divisionId}`)
    ...
    districtSelect.addEventListener('change', function() {
        ...
        if (districtId) {
            fetch(`/superadmin/filter-upzilas/${districtId}`)
                .then(response => response.json())
                .then(data => {
                    data.forEach(upzila => {
                        const option = document.createElement('option');
    ...
    upzilaSelect.addEventListener('change', function() {
        ...
        if (upzilaId) {
            fetch(`/superadmin/filter-phos/${upzilaId}`)
                .then(response => response.json())
                .then(data => {
                    data.forEach(pho => {
                        const option = document.createElement('option');
