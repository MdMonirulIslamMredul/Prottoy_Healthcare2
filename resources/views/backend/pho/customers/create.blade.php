                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text text-muted">Accepts 01XXXXXXXXX format only.</div>
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Client-side phone validation (Bangladesh formats)
                ...
                if (form && phoneInput) {
                    form.addEventListener('submit', function(e) {
                        ...
                        // allow HTML5 required to handle empty; here we only validate format
