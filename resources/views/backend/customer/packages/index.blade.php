            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    @forelse($purchases as $purchase)
                        <div class="card mb-3 border-start border-5 @if($purchase->payment_status == 'paid') border-success @elseif($purchase->payment_status == 'partial') border-warning @else border-danger @endif">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <h5 class="card-title">{{ $purchase->package->name }}</h5>
                                        <p class="card-text text-muted mb-2">{{ Str::limit($purchase->package->details, 100) }}</p>
                                        <p class="mb-1">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <p class="mb-0 text-danger">৳{{ number_format($purchase->due_amount, 2) }}</p>
                                        </div>
                                    </div>
