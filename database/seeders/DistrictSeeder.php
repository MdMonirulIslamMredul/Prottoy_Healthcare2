...
class DistrictSeeder extends Seeder
{
    ...
    {
        // Import districts data from SQL file
        $sqlFile = database_path('seeders/data/districts.sql');

        if (file_exists($sqlFile)) {
            DB::unprepared(file_get_contents($sqlFile));
        } else {
            // Fallback: Insert data directly
    ...
    private function insertDistricts(): void
    {
        $districts = [
            ...
            ['id' => 10, 'division_id' => 1, 'name' => 'Khagrachhari', 'bn_name' => 'খাগড়াছড়ি', 'lat' => '23.119285', 'lon' => '91.984663', 'url' => 'www.khagrachhari.gov.bd'],
            ...
            ['id' => 17, 'division_id' => 2, 'name' => 'Joypurhat', 'bn_name' => 'জয়পুরহাট', 'lat' => '25.09636876', 'lon' => '89.04004280', 'url' => 'www.joypurhat.gov.bd'],
            ...
            ['id' => 31, 'division_id' => 4, 'name' => 'Patuakhali', 'bn_name' => 'পটুয়াখালী', 'lat' => '22.3596316', 'lon' => '90.3298712', 'url' => 'www.patuakhali.gov.bd'],
            ...
            ['id' => 44, 'division_id' => 6, 'name' => 'Tangail', 'bn_name' => 'টাঙ্গাইল', 'lat' => '24.26361358', 'lon' => '89.91794786', 'url' => 'www.tangail.gov.bd'],
            ...
            ['id' => 49, 'division_id' => 6, 'name' => 'Rajbari', 'bn_name' => 'রাজবাড়ী', 'lat' => '23.7574305', 'lon' => '89.6444665', 'url' => 'www.rajbari.gov.bd'],
            ...
            ['id' => 60, 'division_id' => 7, 'name' => 'Kurigram', 'bn_name' => 'কুড়িগ্রাম', 'lat' => '25.805445', 'lon' => '89.636174', 'url' => 'www.kurigram.gov.bd'],
            ['id' => 61, 'division_id' => 8, 'name' => 'Sherpur', 'bn_name' => 'শেরপুর', 'lat' => '25.0204933', 'lon' => '90.0152966', 'url' => 'www.sherpur.gov.bd'],
            ['id' => 62, 'division_id' => 8, 'name' => 'Mymensingh', 'bn_name' => 'ময়মনসিংহ', 'lat' => '24.7465670', 'lon' => '90.4072093', 'url' => 'www.mymensingh.gov.bd'],
